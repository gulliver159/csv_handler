...
class ControllerUnitTest {
    ...
    void testCreateResults() throws Exception {
        ...
        when(service.createResults(any(ContentDtoRequest.class))).thenReturn(new ResultDtoResponse(answer));
    ...
    void testCreateResultsByUser() throws Exception {
        ...
        when(service.createResultsByUser(any(CreateByUserDtoRequest.class))).thenReturn(new ResultDtoResponse(answer));
    ...
    void testGetResultsByUsername() throws Exception {
        ...
        when(service.getResultsByUser(anyString())).thenReturn(new ResultDtoResponse(answer));
